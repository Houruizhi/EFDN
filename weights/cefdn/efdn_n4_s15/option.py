...
parser.add_argument("--val_dir", type=str, default='/home/rzhou/ssd_cache/val_color.h5', help="Validating data root")
parser.add_argument("--outf", type=str, default='../experiment/model_efdn', help="Training log dir")
...
parser.add_argument("--noise_level", type=float, default=15, help='Noise level')
