...
parser.add_argument("--outf", type=str, default='../experiment/model_efdn_color', help="Training log dir")
parser.add_argument("--seed", type=int, default=1234, help="initial random seed")
parser.add_argument("--repeat", type=int, default=32, help="Repeat the training data")
