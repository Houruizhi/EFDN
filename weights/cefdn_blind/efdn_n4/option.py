...
parser.add_argument("--norm_type", type=str, default=None, help='Normalization')
...
# dataloader settings
parser.add_argument("--train_dir", type=str, default='/home/rzhou/ssd_cache/train_color.h5', help="Training data root")
parser.add_argument("--val_dir", type=str, default='/home/rzhou/ssd_cache/val.h5', help="Validating data root")
parser.add_argument("--outf", type=str, default='../experiment/model_efdn_rw', help="Training log dir")
parser.add_argument("--seed", type=int, default=1234, help="initial random seed")
parser.add_argument("--repeat", type=int, default=2, help="Repeat the training data")
parser.add_argument("--noise_level", type=float, default=25, help='Noise level')
parser.add_argument("--batch_size", type=int, default=1, help="Training batch size")
parser.add_argument("--patch_size", type=int, default=160, help="Training data patch size")
...
parser.add_argument("--gpu_ids", type=str, default='3', help="Visible gpu ids")
