...
parser.add_argument("--num_iter", type=int, default=12, help='iteration number')
...
parser.add_argument("--outf", type=str, default='../experiment/efdn_n12_s15', help="Training log dir")
