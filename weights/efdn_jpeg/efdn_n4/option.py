...
parser.add_argument("--in_channel", type=int, default=1, help='Input channel')
parser.add_argument("--out_channel", type=int, default=1, help='Output channel')
...
# dataloader settings
parser.add_argument("--train_dir", type=str, default='/home/rzhou/ssd_cache/train.h5', help="Training data root")
parser.add_argument("--val_dir", type=str, default='/home/rzhou/ssd_cache/val.h5', help="Validating data root")
parser.add_argument("--outf", type=str, default='../experiment/model_efdn_jpeg_gray', help="Training log dir")
...
parser.add_argument("--noise_level", type=float, default=25, help='Noise level')
parser.add_argument("--batch_size", type=int, default=32, help="Training batch size")
parser.add_argument("--patch_size", type=int, default=80, help="Training data patch size")
parser.add_argument("--num_worker", type=int, default=1, help="Workers number to load data")
